...
export default function Circles({item, setSelectedItem}: Props) {
	...
	return (
		<div>
			<img
				className={`w-32 h-32 rounded-full mx-auto cursor-pointer border-2 hover:m-4 ${madrasah.borderColor} border-opacity-50 shadow-lg transform hover:scale-125 hover:shadow-2xl`}
				src={profileImageUrl}
				alt=""
				width="384"
				height="512"
